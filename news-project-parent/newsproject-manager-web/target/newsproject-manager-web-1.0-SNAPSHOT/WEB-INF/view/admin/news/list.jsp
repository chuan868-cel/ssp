...
<body>
    ...
    <div class="panel-head">
        ...
        <a href="${root}/admin/news/edit" style="float:right">添加新闻</a>
        </div>
      ...
      <c:forEach items="${newsList}" var="n" varStatus="v">
        <tr>
          <td style="text-align:left; padding-left:20px;">
           ${v.count}</td>
          <td>
              <a href="${root}/admin/news/detail?id=${n.id}">${n.title}</a>
          </td>
          <td>
              <fmt:formatDate value="${n.publishTime}" pattern="yyyy-MM-dd"/>
          </td>
          ...
          <td>
              <div class="button-group">
                  <a class="button border-main" href="${root}/admin/news/edit?id=${n.id}">
                      <span class="icon-edit"></span>编辑</a>
                  <a class="button border-red" href="javascript:void(0)" data-id="${n.id}" onclick="return del(this)">
